...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  if(htim_ic->Instance==TIM2)
  {
    ...
    PA2     ------> TIM2_CH3
    */
    GPIO_InitStruct.Pin = ULTRASSON_ECHO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(ULTRASSON_ECHO_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim_ic->Instance==TIM5)
  {
    ...
    PA0-WKUP     ------> TIM5_CH1
    */
    GPIO_InitStruct.Pin = TACOMETRO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
    HAL_GPIO_Init(TACOMETRO_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  if(htim_ic->Instance==TIM2)
  {
    ...
    PA2     ------> TIM2_CH3
    */
    HAL_GPIO_DeInit(ULTRASSON_ECHO_GPIO_Port, ULTRASSON_ECHO_Pin);
  ...
  else if(htim_ic->Instance==TIM5)
  {
    ...
    PA0-WKUP     ------> TIM5_CH1
    */
    HAL_GPIO_DeInit(TACOMETRO_GPIO_Port, TACOMETRO_Pin);
